...
extension UIColor {
    ...
    class func goldColor() -> UIColor {
        return UIColor(red: 215.0/255, green: 180.0/255, blue: 46.0/255, alpha: 1.0)
    }
    
    class func navigationBarOffWhite() -> UIColor {
        return UIColor(red: 250.0/255, green: 235.0/255, blue: 215.0/255, alpha: 1)
    }
